...
DeckCal accesses your Google Calendar on a read-only basis and stores everything locally on your own machine. See the [DeckCal privacy policy](/projects/deckcal/privacy/) for full details.
