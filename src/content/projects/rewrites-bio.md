---
title: rewrites.bio
description: A manifesto for AI-assisted modernisation of bioinformatics software
...
[**rewrites.bio**](https://rewrites.bio) is a manifesto for AI-assisted modernisation of bioinformatics software.
...
Projects that follow the principles can display a [rewrites.bio badge](https://rewrites.bio#badges) to signal that they have been built with these values in mind. [RustQC](/projects/rustqc) was the first project to adopt the manifesto.

For more information, read the full manifesto at [rewrites.bio](https://rewrites.bio) or browse the source on [GitHub](https://github.com/seqeralabs/rewrites.bio).

![rewrites.bio social card](/images/projects/rewrites-bio-hero.svg)
